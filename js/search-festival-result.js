...
function getData() {
  ...
  axios
    .get(
      `https://tdx.transportdata.tw/api/basic/v2/Tourism/Activity?%24filter=Class1%20eq%20'${thisCategory}'%20or%20Class2%20eq%20'${thisCategory}'&%24format=JSON`,
      {
...
function renderPageDate(nowPage) {
  ...
  result.forEach(function (item, index) {
    ...
    const selectTime = +new Date(
      document.querySelector(".l-search-date").value
    );
...
send.addEventListener("click", function (e) {
  ...
  if (
    ...
    axios
      .get(
        `https://tdx.transportdata.tw/api/basic/v2/Tourism/Activity?%24filter=contains(ActivityName%2C%20'${keyword}')&%24format=JSON`,
        {
          headers: getAuthorizationHeader(),
        }
      )
    ...
    axios
      .get(
        `https://tdx.transportdata.tw/api/basic/v2/Tourism/Activity?%24filter=contains(ActivityName%2C%20'${keyword}')%20and%20(Class1%20eq%20'${themeEN}'%20or%20Class2%20eq%20'${themeEN}')%20&%24format=JSON`,
        {
          headers: getAuthorizationHeader(),
        }
      )
    ...
    axios
      .get(
        `https://tdx.transportdata.tw/api/basic/v2/Tourism/Activity/${categolyEN}?%24filter=contains(ActivityName%2C%20'${keyword}')&%24format=JSON`,
        {
          headers: getAuthorizationHeader(),
        }
      )
    ...
    axios
      .get(
        `https://tdx.transportdata.tw/api/basic/v2/Tourism/Activity/${categolyEN}?%24filter=contains(ActivityName%2C%20'${keyword}')%20and%20(Class1%20eq%20'${themeEN}'%20or%20Class2%20eq%20'${themeEN}')%20&%24format=JSON`,
        {
          headers: getAuthorizationHeader(),
        }
      )
...
function getNearbyTourList() {
  ...
  axios
    .get(
      `https://tdx.transportdata.tw/api/basic/v2/Tourism/Activity?%24spatialFilter=nearby(${latitude}%2C%20${longitude}%2C%205000)&%24format=JSON`,
      {
        header: getAuthorizationHeader(),
      }
    )
