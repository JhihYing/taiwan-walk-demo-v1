...
// 1. 得到所有的資料
function getData() {
  // Class1 eq '自然風景類' or Class2 eq '自然風景類' or Class3 eq '自然風景類'
  axios
    .get(
      `https://tdx.transportdata.tw/api/basic/v2/Tourism/ScenicSpot?%24filter=Class1%20eq%20'${thisCategory}'%20or%20Class2%20eq%20'${thisCategory}'%20or%20Class3%20eq%20'${thisCategory}'&%24format=JSON`,
      {
...
function getNearbyTourList() {
  ...
  axios
    .get(
      `https://tdx.transportdata.tw/api/basic/v2/Tourism/ScenicSpot?%24spatialFilter=nearby(${latitude}%2C%20${longitude}%2C%205000)&%24format=JSON`,
      {
        header: getAuthorizationHeader(),
      }
    )
